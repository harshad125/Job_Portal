...
import { deleteProject, getAllProject, getMyProject, getProjectById, makeProject, updateProject, uploadScreenShot } from "../controller/projectController.js";


const projectRouter = Router()

projectRouter.route('/newproject').get(verifyJWT, makeProject);
projectRouter.route('/screenshot').patch(verifyJWT, upload.fields([
    {
        name: "screenshot",
        maxCount: 10
    }
